...
class StaticFixtureAnalyzer extends BaseAnalyzer
{
     ...
     */
    public function prepareTest(TestCase $test, array $fixtures): void
    {
     ...
     * @return void
     */
    public function ignoreTest(TestCase $test, string $msg): void
    {
     ...
     * @return void
     */
    public function storeResult(TestCase $test, bool $fail, string $droppedFixture): void
    {
