...
trait TablesTruncationTrait
{
     ...
     * @return void
     */
    public function preserveOriginalPolicies()
    {
     ...
     * @return void
     */
    public function restoreOriginalPolicies()
    {
     ...
     * @return void
     */
    public function doAllTruncations()
    {
     ...
     * @return void
     */
    public function skipAllTruncations()
    {
     ...
     * @return void
     */
    public function forceTruncation($connectionOrReset, string ...$connections)
    {
     ...
     * @return void
     */
    public function skipTruncation($connectionOrReset, string ...$connections)
    {
        if ($connectionOrReset === false) {
     ...
     */
    public function truncateTables(string $connection = '', string ...$connections): array
    {
        if (empty($connection)) {
     ...
     */
    protected function _checkConnectionsName(array $connections, array $available)
    {
